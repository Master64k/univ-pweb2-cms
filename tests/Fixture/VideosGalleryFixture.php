...
/**
 * VideosGalleryFixture
 *
 */
class VideosGalleryFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'videosgallery_news_id_idx' => ['type' => 'index', 'columns' => ['news_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'videosgallery_news_id' => ['type' => 'foreign', 'columns' => ['news_id'], 'references' => ['news', 'id'], 'update' => 'restrict', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
