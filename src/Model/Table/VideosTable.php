 ...
 * Videos Model
 *
 * @property \App\Model\Table\VideosGalleryTable|\Cake\ORM\Association\BelongsTo $VideosGallery
 *
...
class VideosTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('youtube_url')
            ->maxLength('youtube_url', 135)
            ->requirePresence('youtube_url', 'create')
            ->notEmpty('youtube_url');
    ...
    {
        $rules->add($rules->existsIn(['gallery_id'], 'VideosGallery'));
